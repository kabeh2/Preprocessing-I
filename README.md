...
## FOR THIS PROJECT I WILL PERSONALLY BE USING SASS INSTEAD OF LESS!

For this project you will be building a digital resume from scratch. You will be required to use specific preprocessing skills to accomplish your tasks. AS I WILL BE USING SASS INSTEAD OF LESS, ALL INSTRUCTIONS
BELOW INDICATING LESS WILL BE ACCOMPLISHED WITH SASS!
